...
// //           class="edit-me btn btn-secondary btn-sm mr-25"> 
// //           O'zgartirish 
// //         </button>
// //         <button data-id="${item._id}" class="delete-me btn btn-danger btn-sm mr-25"> O'chirish </button>
// //       </div>
// //     </li>`;
// // }
...
document.addEventListener("click", function (e) {
  ...
  if(e.target.classList.contains("edit-me")) {
    // alert("siz edit tigmasini bosdingiz");
